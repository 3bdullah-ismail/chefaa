...
import 'package:chefaa/presentation/pharmacy/inventory/presentation/pages/add_medicine_page.dart';
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        ...
                        10.horizontalSpace,
                        _buildFilterChip("Out of Stock", "out", context),
                      ],
                    ),
                  ),
                  16.verticalSpace,
                            ...
                            child: Column(
                              children: [
                                ...
                                if (medicines.isNotEmpty)
                                  SectionCard(
                                    title: _selectedFilter == "out" ? "Out of Stock Medicines" : "All Medicines",
                                    ...
                                    children: medicines.map((med) {
                                      ...
                                      return MedicineTile(
                                        ...
                                        stock: stock,
                                        price: med.price?.toInt() ?? 0,
                                        status: stock == 0 ? "Out" : (isLow ? "Low" : "In Stock"),
                                        statusColor: stock == 0 ? Colors.red : (isLow ? Colors.orange : Colors.green),
                                      );
                                    }).toList(),
                                  ),
                              ],
