...
import '../../presentation/doctor/auth/presentation/manager/doctor_auth_cubit.dart'
    as _i236;
import '../../presentation/doctor/layout/home/data/data_sources/clinic_data_source.dart'
    as _i808;
import '../../presentation/doctor/layout/home/data/data_sources/clinic_data_source_imp.dart'
    as _i637;
import '../../presentation/doctor/layout/home/data/repositories/clinic_repo.dart'
    as _i114;
import '../../presentation/doctor/layout/home/data/repositories/clinic_repo_imp.dart'
    as _i334;
import '../../presentation/doctor/layout/home/presentation/manager/clinic_cubit.dart'
    as _i243;
import '../../presentation/doctor/profile/data/data_sources/remote_data_source/remote_data_source.dart'
    as _i1048;
import '../../presentation/doctor/profile/data/data_sources/remote_data_source/remote_data_source_imp.dart'
    as _i515;
import '../../presentation/doctor/profile/data/data_sources/local_data_source/doctor_profile_local_data_source.dart'
    as _i40;
import '../../presentation/doctor/profile/data/data_sources/local_data_source/doctor_profile_local_data_source_imp.dart'
    as _i645;
import '../../presentation/doctor/profile/data/repositories/doctor_profile_repo_impl.dart'
    as _i1010;
import '../../presentation/doctor/profile/domain/repositories/doctor_profile_repo.dart'
    as _i764;
import '../../presentation/doctor/profile/domain/use_cases/get_doctor_data_use_case.dart'
    as _i960;
import '../../presentation/doctor/profile/domain/use_cases/update_doctor_data_use_case.dart'
    as _i388;
import '../../presentation/doctor/profile/presentation/manager/doctor_profile_cubit.dart'
    as _i1069;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i1048.DoctorProfileRemoteDataSource>(
      () => _i515.DoctorProfileRemoteDataSourceImp(gh<_i463.NetworkService>()),
    );
    gh.factory<_i40.DoctorProfileLocalDataSource>(
      () => _i645.DoctorProfileLocalDataSourceImp(),
    );
    ...
    gh.factory<_i764.DoctorProfileRepo>(
      () => _i1010.DoctorProfileRepoImpl(
        gh<_i1048.DoctorProfileRemoteDataSource>(),
        gh<_i40.DoctorProfileLocalDataSource>(),
      ),
    );
    ...
    gh.factory<_i960.GetDoctorDataUseCase>(
      () => _i960.GetDoctorDataUseCase(gh<_i764.DoctorProfileRepo>()),
    );
    gh.factory<_i388.UpdateDoctorDataUseCase>(
      () => _i388.UpdateDoctorDataUseCase(gh<_i764.DoctorProfileRepo>()),
    );
    gh.factory<_i236.DoctorAuthCubit>(
      () => _i236.DoctorAuthCubit(
        doctorAuthRepo: gh<_i551.DoctorAuthRepo>(),
        usersCubit: gh<_i745.UsersCubit>(),
      ),
    );
    gh.factory<_i1069.DoctorProfileCubit>(
      () => _i1069.DoctorProfileCubit(
        getDoctorDataUseCase: gh<_i960.GetDoctorDataUseCase>(),
        updateDoctorDataUseCase: gh<_i388.UpdateDoctorDataUseCase>(),
      ),
    );
