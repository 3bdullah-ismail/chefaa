...
import '../../presentation/patient/profile/presentation/manager/profile_cubit.dart'
    as _i779;
import '../../presentation/patient/search/data/datasources/search_data_source.dart'
    as _i446;
import '../../presentation/patient/search/data/datasources/search_data_source_imp.dart'
    as _i599;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i446.SearchDataSource>(
        () => _i599.SearchDataSourceImp(gh<_i463.NetworkService>()));
    ...
    gh.factory<_i269.SearchRepo>(
        () => _i216.SearchRepoImp(gh<_i446.SearchDataSource>()));
